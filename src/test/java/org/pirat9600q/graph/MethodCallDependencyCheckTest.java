    ...
    public void testSimpleDependency() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("dependencyDependency2()")
                    .isStatic(false).isOverride(false).isOverloaded(false).isVarArg(false)
                    .minArgCount(0).index(4).accessibility(Accessibility.PUBLIC).get())
    ...
    public void testAnonymousClasses() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("a(String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(2).accessibility(Accessibility.PUBLIC).get())
    ...
    public void testMethodSignatures() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("m(byte)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(3).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(short)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(4).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(int)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(5).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(long)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(6).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(double)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(7).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(8).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(2).index(9).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,Integer...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(1).index(10).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(Integer...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(0).index(11).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(int[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(12).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(Long[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(13).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(14).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,List...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(1).index(15).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(16).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List[]...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(0).index(17).accessibility(Accessibility.PUBLIC).get())
                .get();
