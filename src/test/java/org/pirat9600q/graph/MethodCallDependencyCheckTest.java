...
public class MethodCallDependencyCheckTest extends BaseCheckTestSupport {
    ...
    public void testSimpleDependency() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                .addMethod(MethodInfo.builder().signature("InputSimpleDependency()")
                    ...
                    .minArgCount(0).index(0).atLine(5).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("dependant()")
                    .isStatic(false).isOverride(false).isOverloaded(false).isVarArg(false)
                    .minArgCount(0).index(1).atLine(9).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("dependency()")
                    .isStatic(false).isOverride(false).isOverloaded(false).isVarArg(false)
                    .minArgCount(0).index(2).atLine(13).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("dependencyDependency1()")
                    .isStatic(false).isOverride(false).isOverloaded(false).isVarArg(false)
                    .minArgCount(0).index(3).atLine(18).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("dependencyDependency2()")
                    .isStatic(false).isOverride(false).isOverloaded(false).isVarArg(false)
                    .minArgCount(0).index(4).atLine(22).accessibility(Accessibility.PUBLIC).get())
    ...
    public void testAnonymousClasses() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("a()")
                    ...
                    .minArgCount(0).index(1).atLine(36).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("a(String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(2).atLine(40).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("topLevelMethod()")
                    .notStatic().notOverride().notOverloaded().notVarArg()
                    .minArgCount(0).index(3).atLine(44).accessibility(Accessibility.PUBLIC).get())
                .get();
    ...
    public void testMethodNameClashes() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("format(String)")
                    .notStatic().notOverride().notOverloaded().notVarArg()
                    .minArgCount(1).index(1).atLine(9).accessibility(Accessibility.PUBLIC).get())
                .get();
    ...
    public void testMethodSignatures() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                .addMethod(MethodInfo.builder().signature("m()")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(0).index(0).atLine(7).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(boolean)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(1).atLine(9).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(char)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(2).atLine(11).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(byte)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(3).atLine(13).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(short)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(4).atLine(15).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(int)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(5).atLine(17).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(long)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(6).atLine(19).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(double)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(7).atLine(21).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(8).atLine(23).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,String)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(2).index(9).atLine(25).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,Integer...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(1).index(10).atLine(27).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(Integer...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(0).index(11).atLine(29).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(int[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(12).atLine(31).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(Long[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(13).atLine(33).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List)")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(14).atLine(35).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(String,List...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(1).index(15).atLine(37).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List[])")
                    .notStatic().notOverride().isOverloaded().notVarArg()
                    .minArgCount(1).index(16).atLine(39).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("m(List[]...)")
                    .notStatic().notOverride().isOverloaded().isVarArg()
                    .minArgCount(0).index(17).atLine(41).accessibility(Accessibility.PUBLIC).get())
                .get();
    ...
    public void testVarargMethodCall() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("varargMethod(Integer...)")
                    ...
                    .minArgCount(0).index(3).atLine(17).accessibility(Accessibility.PUBLIC).get())
    ...
    public void testMethodCallsInLambda() throws Exception {
        ...
        final DependencyInfo info = DependencyInfo.builder()
                ...
                .addMethod(MethodInfo.builder().signature("dependency()")
                    .notStatic().notOverride().notOverloaded().notVarArg()
                    .minArgCount(0).index(1).atLine(11).accessibility(Accessibility.PUBLIC).get())
    ...
    public void testMethodCallThroughMethodReference() throws Exception {
        ...
        final DependencyInfo expected = DependencyInfo.builder()
                .addMethod(MethodInfo.builder().signature("a()")
                    .notStatic().notOverride().notOverloaded().notVarArg()
                    .minArgCount(0).index(0).atLine(9).accessibility(Accessibility.PUBLIC).get())
                .addMethod(MethodInfo.builder().signature("filter(Integer)")
                    .isStatic().notOverride().notOverloaded().notVarArg()
                    .minArgCount(1).index(1).atLine(15).accessibility(Accessibility.PUBLIC).get())
